...
describe('TodoService Unit Tests', () => {
    ...
    test('should add a new todo', () => {
        ...
        expect(service.getTodos()[0].text).toBe('Do exercises');
    });
    ...
    test('should toggle the completed state of a todo', () => {
        ...
        service.toggleTodoComplete(idTask);
    ...
    test('should remove a todo', () => {
        // TODO: Add a todo.
        service.addTodo('Go to gym');
        // Get its ID and call the removeTodo method.
        idTask = service.getTodos()[0].id;
        service.removeTodo(idTask);
